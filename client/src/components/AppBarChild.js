        ...
        return (
            <Toolbar style={{ backgroundColor: "#333333" }}>
                ...
                <ToolbarGroup lastChild={true}>
                        ...
                        {this.props.user && this.props.user.name ? <div className="log"><FlatButton labelStyle={{ color: '#ffffff' }} label="Log Out" onTouchTap={this.props.logOut} /> </div> : <div className="logIn"><FlatButton labelStyle={{ color: '#ffffff' }} href={'/login'} label="Log In" /></div>}
