...
class Profile extends Component {
    ...
    render() {
        ...
        for (let i = 0; i < 5; i++) {
            i < this.state.user.rank ? rank.push(<FullStar style={{ width: '18px', height: '18px' }} viewBox='-1.5 -1.5 27 27' color={colors[`${this.state.user.rank}`]} key={i} />) : rank.push(<Star style={{ width: '18px', height: '18px' }} viewBox='-1.5 -1.5 27 27' color='#f4dacb' key={i} />)
        }
                        ...
                        <CardMedia >
                            ...
                            <cardText>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', flex: 1, padding: '10px 0px 10px 0px' }}>
                                    <h4 style={{ textAlign: 'center' }} >{this.state.user.name}</h4>
                                    <div style={{ display: 'flex' }}>
                                        ...
                                        <div style={{ flex: 0.5, display: 'flex', flexDirection: 'column' }}>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'center' }} >{parseFloat(this.state.user.points).toFixed(0)}</div>
                                        </div>
                                    </div>
                                </div>
                            </cardText>
